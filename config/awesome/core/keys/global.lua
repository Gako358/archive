...
local globalKeys =
  ...
  awful.key(
    ...
    function()
      width = 400
      height = 300
      awful.util.spawn_with_shell('/home/merrinx/.config/awesome/scripts/ncmpcpp.sh')
    end,
  ...
  awful.key(
    ...
    'm',
    function()
      awful.util.spawn_with_shell('/home/merrinx/.config/awesome/scripts/mutt.sh')
    end,
  ...
  awful.key(
    ...
    'h',
    function()
      awful.util.spawn_with_shell('/home/merrinx/.config/awesome/scripts/htop.sh')
    end,
  ...
  awful.key(
    ...
    'grave',
    function()
      awful.util.spawn_with_shell('/home/merrinx/.config/awesome/scripts/scratchpad.sh')
    end,
    {description = 'Open scratchpad', group = 'launcher'}
  ),
  -- Weechat
  awful.key(
    {modkey, 'Shift'},
    'c',
    function()
      awful.util.spawn_with_shell("kitty --class 'weechat' -e weechat &")
    end,
  ...
  awful.key(
    ...
    {description = 'norwegian language', group = 'language'}
  ),
  awful.key(
    {modkey, 'Ctrl'},
    'u',
    ...
    {description = 'english language', group = 'language'}
  ),
  -- Standard program
  awful.key(
    {modkey},
  ...
  awful.key(
    ...
    {description = 'toggle pause', group = 'hotkeys'}
  ),
  awful.key(
    {},
    'XF86PowerDown',
